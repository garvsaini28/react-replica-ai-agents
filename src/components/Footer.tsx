...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-80 h-80 bg-tech-blue/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-tech-purple/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="hover:text-tech-cyan transition-colors">Pricing</a></li>
              ...
              <li><a href="#" className="hover:text-tech-cyan transition-colors">API Reference</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="hover:text-tech-cyan transition-colors">About Us</a></li>
              <li><a href="#" className="hover:text-tech-cyan transition-colors">Blog</a></li>
              <li><a href="#" className="hover:text-tech-cyan transition-colors">Careers</a></li>
              <li><a href="#" className="hover:text-tech-cyan transition-colors">Press Kit</a></li>
              <li><a href="#" className="hover:text-tech-cyan transition-colors">Contact</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="mb-4 md:mb-0">&copy; 2025 ReplicaAI. All rights reserved.</p>
            <div className="flex space-x-6">
              ...
              <a href="#" className="hover:text-tech-cyan transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
